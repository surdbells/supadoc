    ...
    >
      <sd-card>
        <div class="flex flex-col items-start gap-4">
          ...
          >
            <sd-icon name="stethoscope" [size]="14" />
            Supadoc
          </span>
          <h1 class="text-3xl font-bold text-surface-900">Doctor Portal</h1>
          <p class="max-w-prose text-surface-500">
            Monorepo scaffold is ready. Build the doctor experience from the
