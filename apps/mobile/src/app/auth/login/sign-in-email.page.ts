    ...
    <ion-content class="ion-padding">
      <div class="auth">
        ...
        <div class="auth__head">
          <h1 class="auth__title">Sign In with your Email</h1>
          <p class="auth__sub">
            Enter your email to log in to your VideoMed account
          </p>
        </div>
        ...
        <form [formGroup]="form" (ngSubmit)="submit()">
          ...
          <a routerLink="/auth/recover/email" class="auth__link auth__forgot">
            Forgot Password?
          </a>
