    ...
    >
      <sd-card>
        <div class="flex flex-col items-start gap-4">
          ...
          >
            <sd-icon name="heart-pulse" [size]="14" />
            Supadoc
          </span>
          <h1 class="text-3xl font-bold text-surface-900">Patient Portal</h1>
          <p class="max-w-prose text-surface-500">
            Monorepo scaffold is ready. Build the patient experience from the
            Figma designs using the shared <code>&#64;supadoc/ui</code>
            components, Lucide icons and Tailwind design tokens.
          </p>
