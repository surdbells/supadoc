...
/** Registration entry (Figma 254:3640): choose Google / Email / Phone to sign up. */
@Component({
  selector: 'pat-register-method',
    ...
    <div class="flex flex-col gap-14">
      ...
      <div class="flex flex-col gap-10">
        <div class="flex flex-col gap-4 text-center">
          <h2 class="font-heading text-h2 text-ink">Create your account</h2>
          <p class="text-h5 text-slate">Choose your sign up method</p>
        </div>

        <div class="flex flex-col gap-6">
          <a routerLink="/auth/register/google" [class]="methodClass">
          ...
          <a routerLink="/auth/register/email" [class]="methodClass">
